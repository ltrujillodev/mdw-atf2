...
function DemoPageContent({ pathname }) {
  return (
    ...
    >
      ...
      {pathname === "/resena-negocios" && <Reseñas />}

      {/* PARA TI */}
      {pathname === "/clientes" && <Clientes />}
      {pathname === "/reservas-clientes" && <ReservasClientes />}
      {pathname === "/mensajes-clientes" && <MesajesClientes />}
    </Box>
  );
}
  ...
  return (
    <ThemeProvider theme={demoTheme(mode)}>
      ...
      <AppProvider
        ...
        branding={{
          logo: (
            <img src="./src/assets/icon-mesa-facil.png" alt="Mesa Fácil logo" />
          ),
          title: (
            <p style={{ color: "#ffc107", fontSize: 20, marginLeft: 10 }}>
              Mesa Fácil
            </p>
          ),
        }}
