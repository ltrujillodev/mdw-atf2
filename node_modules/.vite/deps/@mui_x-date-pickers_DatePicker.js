...
} from "./chunk-BTPH55U7.js";
import {
  DialogActions_default,
  DialogContent_default,
  Dialog_default,
  dialogClasses_default
} from "./chunk-2PCZJF6Y.js";
import "./chunk-YQBMKNN2.js";
import {
  InputAdornment_default
} from "./chunk-VW2ULJQH.js";
import {
  TextField_default
} from "./chunk-ZFZQXXBO.js";
...
var DateField = React26.forwardRef(function DateField2(inProps, inRef) {
  const themeProps = useThemeProps({
    props: inProps,
    name: "MuiDateField"
  });
...
function PickersSlideTransition(inProps) {
  ...
  return (0, import_jsx_runtime14.jsx)(PickersSlideTransitionRoot, {
    className: clsx_default(classes.root, className),
    childFactory: (element) => React31.cloneElement(element, {
      classNames: transitionClasses
    }),
    role: "presentation",
    children: (0, import_jsx_runtime14.jsx)(CSSTransition_default, _extends({
      mountOnEnter: true,
      unmountOnExit: true,
...
function WrappedDay(_ref) {
  ...
  return (0, import_jsx_runtime15.jsx)(Day, _extends({}, dayProps, {
    day,
    disabled: isDisabled,
...
function DayCalendar(inProps) {
  ...
  const {
    ...
    readOnly,
    reduceAnimations,
    renderLoading = () => (0, import_jsx_runtime15.jsx)("span", {
      children: "..."
    }),
    slideDirection,
    TransitionProps,
  ...
  return (0, import_jsx_runtime15.jsxs)(PickersCalendarDayRoot, {
    role: "grid",
    "aria-labelledby": gridLabelId,
    className: classes.root,
    children: [(0, import_jsx_runtime15.jsxs)(PickersCalendarDayHeader, {
      role: "row",
      className: classes.header,
      children: [displayWeekNumber && (0, import_jsx_runtime15.jsx)(PickersCalendarWeekNumberLabel, {
        variant: "caption",
        role: "columnheader",
        "aria-label": translations.calendarWeekNumberHeaderLabel,
        className: classes.weekNumberLabel,
        children: translations.calendarWeekNumberHeaderText
      }), getWeekdays(utils, now).map((weekday, i) => (0, import_jsx_runtime15.jsx)(PickersCalendarWeekDayLabel, {
        variant: "caption",
        role: "columnheader",
    ...
    }), loading ? (0, import_jsx_runtime15.jsx)(PickersCalendarLoadingContainer, {
      className: classes.loadingContainer,
      children: renderLoading()
    }) : (0, import_jsx_runtime15.jsx)(PickersCalendarSlideTransition, _extends({
      ...
      children: (0, import_jsx_runtime15.jsx)(PickersCalendarWeekContainer, {
        ref: slideNodeRef,
        role: "rowgroup",
        className: classes.monthContainer,
        children: weeksToDisplay.map((week, index) => (0, import_jsx_runtime15.jsxs)(PickersCalendarWeek, {
          role: "row",
          className: classes.weekContainer,
          "aria-rowindex": index + 1,
          children: [displayWeekNumber && (0, import_jsx_runtime15.jsx)(PickersCalendarWeekNumber, {
            className: classes.weekNumber,
            role: "rowheader",
            "aria-label": translations.calendarWeekNumberAriaLabelText(utils.getWeekNumber(week[0])),
            children: translations.calendarWeekNumberText(utils.getWeekNumber(week[0]))
          }), week.map((day, dayIndex) => (0, import_jsx_runtime15.jsx)(WrappedDay, {
            parentProps: props,
            day,
...
var PickersMonth = React33.memo(function PickersMonth2(inProps) {
  ...
  return (0, import_jsx_runtime16.jsx)(PickersMonthRoot, _extends({
    ...
    children: (0, import_jsx_runtime16.jsx)(MonthButton, _extends({}, monthButtonProps))
  }));
});
...
var PickersYear = React35.memo(function PickersYear2(inProps) {
  ...
  return (0, import_jsx_runtime18.jsx)(PickersYearRoot, _extends({
    ...
    children: (0, import_jsx_runtime18.jsx)(YearButton, _extends({}, yearButtonProps))
  }));
});
...
var PickersArrowSwitcher = React37.forwardRef(function PickersArrowSwitcher2(inProps, ref) {
  const isRtl = useRtl();
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersArrowSwitcher"
...
var PickersCalendarHeader = React39.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  ...
  return (0, import_jsx_runtime21.jsxs)(PickersCalendarHeaderRoot, _extends({}, other, {
    ...
    children: [(0, import_jsx_runtime21.jsxs)(PickersCalendarHeaderLabelContainer, {
      ...
      children: [(0, import_jsx_runtime21.jsx)(PickersFadeTransitionGroup, {
        reduceAnimations,
        transKey: label,
        children: (0, import_jsx_runtime21.jsx)(PickersCalendarHeaderLabel, {
          id: labelId,
          ownerState,
          className: classes.label,
          children: label
        })
      }), views.length > 1 && !disabled && (0, import_jsx_runtime21.jsx)(SwitchViewButton, _extends({}, switchViewButtonProps, {
        children: (0, import_jsx_runtime21.jsx)(SwitchViewIcon, _extends({}, switchViewIconProps))
      }))]
    }), (0, import_jsx_runtime21.jsx)(Fade_default, {
      in: view === "day",
      children: (0, import_jsx_runtime21.jsx)(PickersArrowSwitcher, {
        slots,
        slotProps,
...
function useDateCalendarDefaultizedProps(props, name) {
  ...
  return _extends({}, themeProps, {
    ...
    renderLoading: themeProps.renderLoading ?? (() => (0, import_jsx_runtime22.jsx)("span", {
      children: "..."
    })),
    minDate: applyDefaultDate(utils, themeProps.minDate, defaultDates.minDate),
    maxDate: applyDefaultDate(utils, themeProps.maxDate, defaultDates.maxDate)
...
var DateCalendar = React40.forwardRef(function DateCalendar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime22.jsxs)(DateCalendarRoot, _extends({
    ...
    children: [(0, import_jsx_runtime22.jsx)(CalendarHeader, _extends({}, calendarHeaderProps, {
      slots,
      slotProps
    })), (0, import_jsx_runtime22.jsx)(DateCalendarViewTransitionContainer, {
      reduceAnimations,
...
function PickersModalDialog(props) {
  ...
  return (0, import_jsx_runtime24.jsx)(Dialog, _extends({
    open,
    onClose: onDismiss
    ...
    children: (0, import_jsx_runtime24.jsx)(PickersModalDialogContent, {
      children
    })
  }));
}
...
var useMobilePicker = (_ref) => {
  ...
  const fieldRef = React44.useRef(null);
  const labelId = useId();
  const isToolbarHidden = ((_a = innerSlotProps == null ? void 0 : innerSlotProps.toolbar) == null ? void 0 : _a.hidden) ?? false;
  const {
    open,
  ...
  const renderPicker = () => (0, import_jsx_runtime25.jsxs)(LocalizationProvider, {
    ...
    children: [(0, import_jsx_runtime25.jsx)(Field, _extends({}, fieldProps, {
      ...
      slotProps,
      unstableFieldRef: handleFieldRef
    })), (0, import_jsx_runtime25.jsx)(PickersModalDialog, _extends({}, actions, {
      open,
      slots,
      slotProps,
