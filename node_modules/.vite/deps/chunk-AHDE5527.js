...
function PluginProvider(props) {
  ...
  const formattedSeries = React9.useMemo(() => ({
    isInitialized: true,
...
function SeriesProvider(props) {
  ...
  const formattedSeries = React16.useMemo(() => ({
    isInitialized: true,
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React17.useContext(SeriesContext);
  if (!isInitialized) {
...
function usePieSeries() {
  ...
  return React17.useMemo(() => series.pie, [series.pie]);
}
function useLineSeries() {
  const series = useSeries();
  return React17.useMemo(() => series.line, [series.line]);
}
function useBarSeries() {
  const series = useSeries();
  return React17.useMemo(() => series.bar, [series.bar]);
}
...
function CartesianProvider(props) {
  ...
  const xValues = React21.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React21.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
var HighlightedContext = React25.createContext({
  isInitialized: false,
  data: {
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React26.useContext(HighlightedContext);
  if (!isInitialized) {
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React28.useMemo(() => {
  ...
  const providerValue = React28.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
function useChartId() {
  const {
    chartId
  } = React31.useContext(DrawingContext);
  return React31.useMemo(() => chartId, [chartId]);
}
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime8.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index) => {
      ...
      return (0, import_jsx_runtime8.jsxs)(React34.Fragment, {
...
var useEnhancedEffect = typeof window !== "undefined" ? React42.useLayoutEffect : React42.useEffect;
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  ...
  const computeSize = React43.useCallback(() => {
...
var _excluded5 = ["width", "height", "resolveSizeBeforeRender", "margin", "children", "series", "colors", "dataset", "desc", "disableAxisListener", "highlightedItem", "onHighlightChange", "plugins", "sx", "title", "viewBox", "xAxis", "yAxis", "zAxis"];
...
var ResponsiveChartContainer = React44.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
...
function ChartsText(props) {
  ...
  const wordsByLines = React52.useMemo(() => getWordsByLines({
    style,
...
function ChartsXAxis(inProps) {
  ...
  return (0, import_jsx_runtime15.jsxs)(XAxisRoot, {
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime16.jsxs)(YAxisRoot, {
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime17.jsxs)(React56.Fragment, {
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React57.useState(null);
  React57.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React61.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React61.useMemo(() => {
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime23.jsxs)("g", {
    ...
    }), (0, import_jsx_runtime23.jsx)("rect", {
...
function LegendPerItem(props) {
  ...
  const padding = React66.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
...
var _excluded11 = ["drawingArea", "seriesToDisplay", "hidden", "onItemClick"];
...
function DefaultChartsLegend(props) {
  ...
  return (0, import_jsx_runtime25.jsx)(LegendPerItem, _extends({}, other, {
...
true ? DefaultChartsLegend.propTypes = {
  ...
  seriesToDisplay: import_prop_types16.default.arrayOf(import_prop_types16.default.shape({
    ...
    itemId: import_prop_types16.default.oneOfType([import_prop_types16.default.number, import_prop_types16.default.string]),
    label: import_prop_types16.default.string.isRequired,
    maxValue: import_prop_types16.default.oneOfType([import_prop_types16.default.instanceOf(Date), import_prop_types16.default.number]),
    minValue: import_prop_types16.default.oneOfType([import_prop_types16.default.instanceOf(Date), import_prop_types16.default.number]),
...
function ChartsLegend(inProps) {
  ...
  const {
    slots,
    slotProps
  } = defaultizedProps, other = _objectWithoutPropertiesLoose(defaultizedProps, _excluded12);
  const theme = useTheme();
  ...
  return (0, import_jsx_runtime26.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React69.useContext(ZAxisContext);
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime27.jsxs)(React70.Fragment, {
    children: [(0, import_jsx_runtime27.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime27.jsx)("rect", _extends({
...
var _excluded13 = ["axisDirection", "axisId", "hideFirst", "hideLast", "labelFormatter", "onItemClick"];
...
function ChartsAxisHighlight(props) {
  ...
  const {
    axis
  } = React72.useContext(InteractionContext);
  ...
  return (0, import_jsx_runtime29.jsxs)(React72.Fragment, {
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(StyledText, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime31.jsx)(StyledText2, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime32.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime32.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-AHDE5527.js.map
